...
# Note: facebook/bart-large-mnli is a popular choice, though there are other lightweight options too.
...
def assign_categories_to_clusters(df, text_column="Transaction Description", 
    ...
    for cluster_label in clusters:
        ...
        # Combine a representative sample into one string. You might choose to either join all,
        # or take a subset. Here, we join them with spaces.
